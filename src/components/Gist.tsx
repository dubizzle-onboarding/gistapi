...
const Gist = ({ gist }: { gist: IGist }) => {
    ...
    return <GistCard>
        <div className="heading" style={{ display: 'flex' }}>
            <div className="left" style={{ display: 'flex', flexGrow: 1, alignItems: 'center' }}>
                <span style={{ display: 'flex', alignItems: 'center'}}>
                    ...
                    <StyledLink center={true} bold={true} href={files[0].raw_url}>{files[0].filename}</StyledLink>
                </span>
            </div>
            <GistMetrics>
        ...
        <div className="subheading" style={{ display: 'flex', fontSize: '12px', marginTop: '0.5rem' }}>
        ...
        <FilesList>
            {files.length > 1 && files.map(file => (
                <div style={{marginRight: '1rem', width: '33%'}}>
